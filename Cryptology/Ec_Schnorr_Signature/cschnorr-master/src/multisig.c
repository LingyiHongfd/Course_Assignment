...
// generate a private key and corresponding public key for multiple signature
musig_key *musig_key_new(const schnorr_context *ctx)
{
    ...
    // generate a random number x as private key
...
// sign a message with a private key for multiple signature
...
// verify multiple signature in a batch verify manner instead of single verify
